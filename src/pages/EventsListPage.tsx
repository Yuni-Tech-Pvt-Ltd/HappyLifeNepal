...
export default function EventsListPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Navbar />
      <header className="pt-24 pb-10 bg-gradient-to-br from-blue-50 via-white to-indigo-50 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">All Events</h1>
          <p className="text-gray-600 max-w-2xl">
            Browse upcoming and past events. Join us and be part of the change.
          </p>
